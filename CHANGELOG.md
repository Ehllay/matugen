...
## [3.0.0](https://github.com/Ehllay/matugen/compare/v2.1.0...v3.0.0) - 2024-03-26

### Added
- add `harmonized_colors` to `--json` flag ([#53](https://github.com/Ehllay/matugen/pull/53))
...
- add amoled/"pure dark" mode ([#2](https://github.com/Ehllay/matugen/pull/2))
- add vhs tape gifs
- add vhs tapes
...
- *(macos)* add `enquote` to global dependencies ([#43](https://github.com/Ehllay/matugen/pull/43))
- light/dark theme being swapped everywhere
- fix table light/dark modes
- fix nix module command
- *(macos)* change `use` to `extern` for enquote ([#43](https://github.com/Ehllay/matugen/pull/43))
- *(macos)* enquote not imported ([#43](https://github.com/Ehllay/matugen/pull/43))
- forgot to commit `Cargo.lock`
- make reqwest not use openssl
- remove openssl dependency
- update quantizer arguments [#39](https://github.com/Ehllay/matugen/pull/39)
...
- *(macos)* update specific functions to only run on linux and macos ([#25](https://github.com/Ehllay/matugen/pull/25))
- *(macos)* use conditional import for unsupported modules ([#25](https://github.com/Ehllay/matugen/pull/25))
...
- *(template)* ".hex" not working ([#3](https://github.com/Ehllay/matugen/pull/3))
- swap green and blue channels ([#1](https://github.com/Ehllay/matugen/pull/1) [#3](https://github.com/Ehllay/matugen/pull/3))
...
### Other
- Added cargo-aur dependency
- Create aur.yml
- Merge pull request [#57](https://github.com/Ehllay/matugen/pull/57) from InioX/dev
- remove error message when compiling template
- run `clippy fix`
- release
- Merge pull request [#52](https://github.com/Ehllay/matugen/pull/52) from InioX/dev
- *(readme)* update acknowledgements
- *(readme)* remove roadmap
- bump material-colors ver
- Merge pull request [#46](https://github.com/Ehllay/matugen/pull/46) from InioX/material-colors-rewrite
...
- update gitignore
- release
- Merge pull request [#35](https://github.com/Ehllay/matugen/pull/35) from InioX/release-plz-2023-12-14T18-36-35Z
- run cargo fix
...
- release
- remove build warnings (closes [#17](https://github.com/Ehllay/matugen/pull/17))
- add `--json` docs
- format with cargofmt
- add --json flag
- run formatter
...
- *(core palette)* change "angle" from parameter to variable ([#5](https://github.com/Ehllay/matugen/pull/5))
- *(core palette)* add angle to from_hue_and_chroma ([#5](https://github.com/Ehllay/matugen/pull/5))
